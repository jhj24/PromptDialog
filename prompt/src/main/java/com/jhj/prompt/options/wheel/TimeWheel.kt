 ...
 */
class TimeWheel(mContext: Context) {
    ...
    private var view: View = LayoutInflater.from(mContext).inflate(R.layout.layout_pickerview_time, null)
    ...
    fun setDisplayStyle(style: BooleanArray) {
        this.type = style
    }
    ...
    private fun setSolar(year: Int, month: Int, day: Int, h: Int, m: Int, s: Int) {
        ...
        val listBig = arrayListOf("1", "3", "5", "7", "8", "10", "12")
        val listLittle = arrayListOf("4", "6", "9", "11")
            ...
            override fun onItemSelected(index: Int) {
                ...
                if (startYear == endYear) {
                    ...
                    when {
                        ...
                        monthNum == endMonth -> setReDay(yearNum, monthNum, 1, endDay, listBig, listLittle)
                        else -> //重新设置日
                    ...
                    if (nMonth == startMonth) {
                        //重新设置日
                        setReDay(yearNum, nMonth, startDay, 31, listBig, listLittle)
                    } else {
                        //重新设置日
                        setReDay(yearNum, nMonth, 1, 31, listBig, listLittle)
                    }
                    ...
                    wvMonth.setAdapter(TimeWheelAdapter(1, 12))
                    //重新设置日
                    setReDay(yearNum, wvMonth.currentItem + 1, 1, 31, listBig, listLittle)
            ...
            override fun onItemSelected(index: Int) {
                ...
                if (startYear == endYear) {
                    ...
                    when {
                        ...
                        endMonth == monthNum -> setReDay(currentYear, monthNum, 1, endDay, listBig, listLittle)
                        else -> setReDay(currentYear, monthNum, 1, 31, listBig, listLittle)
                    }
                    ...
                    if (monthNum == endMonth) {
                        //重新设置日
                        setReDay(currentYear, wvMonth.currentItem + 1, 1, endDay, listBig, listLittle)
                    } else {
                        setReDay(currentYear, wvMonth.currentItem + 1, 1, 31, listBig, listLittle)
                    }
        ...
        wvMonth.setOnItemSelectedListener(wheelListenerMonth)
        if (type.size != 6) {
            throw IllegalArgumentException("type[] length is not 6")
        }
        wvYear.visibility = if (type[0]) View.VISIBLE else View.GONE
        wvMonth.visibility = if (type[1]) View.VISIBLE else View.GONE
        wvDay.visibility = if (type[2]) View.VISIBLE else View.GONE
    ...
    private fun setReDay(yearNum: Int, monthNum: Int, startD: Int, endD: Int, listBig: List<String>, listLittle: List<String>) {
        var endDay = endD
    ...
    fun setLabels(label_year: String?, label_month: String?, label_day: String?, label_hours: String?, label_mins: String?, label_seconds: String?) {
        ...
        if (label_year != null) {
            ...
            wvYear.setLabel(view.context.getString(R.string.pickerview_year))
        }
        if (label_month != null) {
            wvMonth.setLabel(label_month)
        } else {
            wvMonth.setLabel(view.context.getString(R.string.pickerview_month))
        }
        if (label_day != null) {
            wvDay.setLabel(label_day)
        } else {
            wvDay.setLabel(view.context.getString(R.string.pickerview_day))
        }
        if (label_hours != null) {
            wvHours.setLabel(label_hours)
        } else {
            wvHours.setLabel(view.context.getString(R.string.pickerview_hours))
        }
        if (label_mins != null) {
            wvMinutes.setLabel(label_mins)
        } else {
            wvMinutes.setLabel(view.context.getString(R.string.pickerview_minutes))
        }
        if (label_seconds != null) {
            wvSeconds.setLabel(label_seconds)
        } else {
            wvSeconds.setLabel(view.context.getString(R.string.pickerview_seconds))
        }
    ...
    fun setTypeface(typeface: Typeface) {
        ...
        wvHours.setTypeface(typeface)
        wvMinutes.setTypeface(typeface)
        wvSeconds.setTypeface(typeface)
    }
}
